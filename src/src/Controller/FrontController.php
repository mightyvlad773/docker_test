...
use App\Heplers\FrontendResponse;
...
class FrontController extends AbstractController
{
    ...
    {
        return $response->setList($newsEntityRepository->findArticles($page, $limit), $page)->flush();
    }
    ...
    {
       return $response->setEntityRresponse($newsEntity)->flush();
    }
}
